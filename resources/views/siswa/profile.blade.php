					...
					<div class="profile-left" style="height: 145%">
						...
						<div class="profile-header">
							...
							<div class="profile-main">
								<img src="{{$siswa->getAvatar()}}" class="img-circle" alt="Avatar" style="max-width: 114px; min-width: 114px">
								...
								<table class="table table-striped">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="#" class="nilai" data-type="text" data-pk="{{$mapel->id}}" data-url="/api/siswa/{{$siswa->id}}/editnilai" data-title="Input nilai">{{$mapel->pivot->nilai}}</a>
											</td>
			...
			<div class="modal-body">
				<form action="/siswa/{{$siswa->id}}/addnilai" method="POST">
					...
					<div class="form-group">
						<label form="mapel">Pilih Mata Pelajaran</label>
